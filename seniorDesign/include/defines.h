...
#define STEPS_PER_LIFT_HUNDREDTH_INCH 28846 / 2 /* NOTE: EXPERIMENTALLY FOUND */
...
#define IN_FOR_45_DEGREE_TURN 11.1
#define IN_FOR_90_DEGREE_TURN 22.2
#define IN_FOR_135_DEGREE_TURN 33.3
